...
namespace OpenAI.Responses
{
    internal partial class InternalComparisonFilterLessThanOrEquals : InternalComparisonFilter, IJsonModel<InternalComparisonFilterLessThanOrEquals>
    {
        ...
        protected override InternalComparisonFilter JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeInternalComparisonFilterLessThanOrEquals(document.RootElement, options);
        }

        internal static InternalComparisonFilterLessThanOrEquals DeserializeInternalComparisonFilterLessThanOrEquals(JsonElement element, ModelReaderWriterOptions options)
        {
