...
namespace OpenAI.Responses
{
    internal partial class InternalResponseReasoningSummaryPartDoneEvent : StreamingResponseUpdate, IJsonModel<InternalResponseReasoningSummaryPartDoneEvent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InternalResponseReasoningSummaryPartDoneEvent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<InternalResponseReasoningSummaryPartDoneEvent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalResponseReasoningSummaryPartDoneEvent)} does not support writing '{options.Format}' format.");
            }
        }

        InternalResponseReasoningSummaryPartDoneEvent IPersistableModel<InternalResponseReasoningSummaryPartDoneEvent>.Create(BinaryData data, ModelReaderWriterOptions options) => (InternalResponseReasoningSummaryPartDoneEvent)PersistableModelCreateCore(data, options);
