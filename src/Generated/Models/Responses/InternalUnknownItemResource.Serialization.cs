...
namespace OpenAI.Responses
{
    internal partial class InternalUnknownItemResource : ResponseItem, IJsonModel<ResponseItem>
    {
        ...
        internal static InternalUnknownItemResource DeserializeInternalUnknownItemResource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InternalUnknownItemResource(kind, id, additionalBinaryDataProperties);
        }
